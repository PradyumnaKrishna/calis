  ...
  return (
    <>
      ...
      <BottomSheet isOpen={isOpen} onClose={() => setIsOpen(false)}>
        <Text className="text-xs font-semibold uppercase text-muted-light dark:text-muted-dark">
          {eyebrow}
        </Text>
        <Text className="mt-4 text-2xl font-bold leading-8 text-foreground-light dark:text-foreground-dark">
          Why this matters
        </Text>
        ...
        <Pressable
          ...
          <Text className="text-base font-bold text-background-light dark:text-background-dark">
            Got it
          </Text>
        </Pressable>
      </BottomSheet>
